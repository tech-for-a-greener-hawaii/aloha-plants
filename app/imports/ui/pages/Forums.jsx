  ...
  return ready ? (
    <div>
      ...
      <Container id={PageIDs.forumsPage} style={pageStyle}>
        {forumData.map((forum, index) => <Row className="justify-content-center py-4"><MakeForumCard key={index} forum={forum} comments={commentData.filter(comment => (comment.forumID === forum._id))} /></Row>)}
